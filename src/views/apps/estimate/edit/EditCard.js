...
const InvoiceEditCard = ({ data }) => {
  ...
  const [picker, setPicker] = useState(new Date(data.estimate.issuedDate))
  const [dueDatepicker, setDueDatePicker] = useState(new Date(data.estimate.dueDate))
      ...
      <CardBody className='invoice-padding pt-0'>
        <Row className='invoice-spacing'>
          <Col className='p-0' xl='8'>
            ...
            <h6 className='mb-25'>{data.estimate.client.name}</h6>
            <CardText className='mb-25'>{data.estimate.client.company}</CardText>
            <CardText className='mb-25'>{data.estimate.client.address}</CardText>
            <CardText className='mb-25'>{data.estimate.client.contact}</CardText>
            <CardText className='mb-0'>{data.estimate.client.companyEmail}</CardText>
          </Col>
